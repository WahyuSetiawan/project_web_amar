...
class GuruModel extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['nuptk', 'nama_guru', 'tempat_lahir', 'tgl_lahir', 'jk', 'agama', 'foto', 'pend_akhir', 'alamat', 'email', 'telepon', 'personal_blog', 'sinopsis', 'level_user'], 'required'],
            [['tgl_lahir'], 'safe'],
            [['jk', 'agama', 'alamat'], 'string'],
            [['level_user'], 'integer'],
            [['nuptk', 'nama_guru', 'email'], 'string', 'max' => 50],
    ...
    public function getMateris() {
        return $this->hasMany(Materi::className(), ['nuptk' => 'nuptk']);
    }
    ...
    public function getPengajars() {
        return $this->hasMany(Pengajar::className(), ['nuptk' => 'nuptk']);
    }
    ...
    public function getUser() {
        return $this->hasOne(User::className(), ['username' => 'nuptk']);
    }
