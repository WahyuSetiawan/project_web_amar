...
/**
 * This is the model class for table "user_guru".
 *
 ...
 *
 * @property Guru $username0
 * @property LevelUser $levelUser
 */
class UserguruModel extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(Guru::className(), ['nuptk' => 'username']);
    }
